                ...
                <div class="row">
                    ...
                    <div class="portfolio-content">
                        ...
                        <?php
                            ...
                            $whether_exist = mysqli_query($link,"select video_name from video where video_name like '%".$_POST["video_name"]."%' ;");
