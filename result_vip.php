                ...
                <div class="row">
                    ...
                    <div class="portfolio-content">
                        ...
                        <?php
                            ...
                            $whether_exist = mysqli_query($link,"select vip_id from vip where web_name = '".$_POST["web"]."' ;");
                            ...
                            if ($whether_exist==[] || $row==[]){
                                ...
                                $test = 2;
                                $result_que =  "select * from vip where web_name = '".$_POST["web"]."' ;";
                                $result = mysqli_query($link,$result_que);
                                while($data= mysqli_fetch_row($result))
                                echo "<b>Vip".$data[0]."</b><br><b>Website: </b>".$data[5]."<br><b>Duration: </b>".$data[4]."<br><b>VIP Price: </b>".$data[2]."<br><b>Vip Authority: </b><br>".$data[3]."<br><b>Vip Property: </b>".$data[6]."<br><br><br><br>";              
                                mysqli_close($link);
                                }
                            } 
                            if ($test == 0){
