                ...
                <div class="row">
                    ...
                    <div class="portfolio-content">
                        ...
                        <?php
                            ...
                            $whether_exist = mysqli_query($link,"select video_name from video where episode_num = ".$_POST["epi"]." ;");
                            ...
                            if ($whether_exist==[] || $row==[]){
                                ...
                                $test = 2;
                                $result_que =  "select * from video natural join blocks where episode_num =  ".$_POST["epi"]." ;";
